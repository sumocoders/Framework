...
class Version20171012095221 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE SumoUser (id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE SumoUser ADD CONSTRAINT FK_A3368EB3BF396750 FOREIGN KEY (id) REFERENCES BaseUser (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE SumoUser DROP FOREIGN KEY FK_A3368EB3BF396750');
        $this->addSql('ALTER TABLE Admin DROP FOREIGN KEY FK_49CF2272BF396750');
        $this->addSql('DROP TABLE SumoUser');
